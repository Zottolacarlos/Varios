...
val_data = val_data.reshape((val_data.shape[0]-5, 5, 1))
...
#print(train_data)
# train_data['columna_problema'] = train_data['columna_problema'].astype(float)
...
print(f"La precisión del modelo es del {accuracy*100}%")